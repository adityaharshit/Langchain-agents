...
class ResearchOrchestrator:
    ...
    def _route_from_factcheck(self, state: ResearchState) -> str:
        ...
        if confidence >= 0.8:  # High threshold for final output
            logger.info(f"High fact-check confidence ({confidence:.2f}) - proceeding to output")
            return "verified_high_confidence"
        else:
            logger.info(f"Low fact-check confidence ({confidence:.2f}) - returning to coordinator")
    ...
    def get_graph_structure(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "edges": [
                ...
                ["research_coordinator", "deep_analysis", "sufficient_retrieval_confidence"],
